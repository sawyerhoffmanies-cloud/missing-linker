...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            const investigationType = contactForm.querySelector('select').value;
            const message = contactForm.querySelector('textarea').value;
            
            // Basic validation
            if (!name || !email || !investigationType || !message) {
...
window.addEventListener('load', function() {
    ...
    style.textContent = `
        ...
        body:not(.loaded)::before {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, #1a237e 0%, #534bae 50%, #00bcd4 100%);
            z-index: 10000;
            display: flex;
            align-items: center;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    progressBar.style.cssText = `
        ...
        width: 0%;
        height: 3px;
        background: linear-gradient(90deg, #00bcd4, #62efff);
        z-index: 1001;
